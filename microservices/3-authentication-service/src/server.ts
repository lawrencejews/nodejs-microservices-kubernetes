...
import { CustomError, IAuthPayload, IErrorResponse, winstonLogger } from '@lawrencejews/marketplace-shared';
import { Logger } from 'winston';
import { config } from '@auth/config';
import { Application, Request, Response, NextFunction, urlencoded, json } from 'express';
import hpp from 'hpp';
...
import { appRoutes } from '@auth/rout';
